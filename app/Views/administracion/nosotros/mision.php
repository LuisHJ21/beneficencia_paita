        ...
        <div class="col-sm-12 col-md-8">
            <div class="card mt-4">
                ...
                <?php } ?>
                    ...
                    <form action="<?php echo base_url() ?>/admin/nosotros/mision/guardar" method="post">
                        <div id="texto" class="form-group text-justify">
                            <?php echo $nosotros['mision'] ?>
                        </div>
                    ...
                    <div class="form-group" style="margin-bottom: 0px !important;">
                            <div class="row justify-content-betwwen">
                                    <div class="col-md-4">
                                        <button id="btneditar" type="button" <?php echo "onclick='editar(`".$nosotros['mision']."`)'"; ?> class="btn btn-primary btn-block"><i class="fas fa-pencil-alt"></i> Editar</button>
                                    </div>
                                    <div class="col-md-4">
